    ...
    <div className="min-h-screen w-full md:max-w-[600px] md:mx-auto flex flex-col pb-12 gap-10">
      ...
      <div className="flex flex-col gap-4">
        ...
        <div className="flex flex-col gap-2">
          <div className="w-[120px] h-[32px] mx-auto bg-zinc-400 rounded animate-pulse"></div>
          <div className="w-[80px] h-[28px] mx-auto bg-zinc-400 rounded animate-pulse"></div>
        </div>
        <div className="w-full flex flex-col gap-2">
          <div className="w-[140px] h-[20px] bg-zinc-400 rounded animate-pulse"></div>
          <div className="w-full h-[120px] bg-zinc-400 rounded animate-pulse"></div>
        </div>
